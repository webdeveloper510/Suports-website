<?php 
   Class Signup_model extends CI_Model { 
	...
	public function update_stat_after_payment($get_uid,$date)
	{
		//echo $get_uid;die;
	$data = array(
	...
	public function update_stat_after_payment_camp($get_uid,$date)
	{
		//echo $get_uid;die;
	$data = array(
				'payment_status' => '1',
				...
				$this->db->where('id',$get_uid);
                $dooo = $this->db->update('camp_payment_data',$data);
